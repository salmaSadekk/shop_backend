...
var Cart = /** @class */ (function () {
    ...
    Cart.prototype.create = function (user_id, status) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new item. Error: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Cart.prototype.deleteProduct = function (productId, orderId) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, added_product, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not remove product. Error: ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
